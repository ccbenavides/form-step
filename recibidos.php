...
// die($_POST['nombres']. " " . $_POST['apellido_paterno'] . " " . $_POST['apellido_materno'] . " " . $_POST['email']);
  $string_sql_update = "UPDATE persona
   SET nombre_per='". $_POST['nombres'] ."', 
       apepat_per='". $_POST['apellido_paterno'] ."', 
       apemat_per='". $_POST['apellido_materno'] ."', 
       email='". $_POST['email'] ."'
...
if(isset($_POST['tipo_forma'])){
    $data_formacion = "";
    if (is_array($_POST['tipo_forma']) || is_object($_POST['tipo_forma']))
      {
